                  ...
                  child: Column(
                    children: <Widget>[
                      _SliderSetting(
                        ...
                        valueLabel: '${controller.maximumSpeed.round()} km/h',
                      ...
                      _SliderSetting(
                        ...
                        valueLabel: '${controller.panelBrightness.round()}%',
                  ...
                  child: ExpansionTile(
                    ...
                    children: <Widget>[
                      ...
                      const Text(
                        ...
                        '"Conectar ESP32 real" en Inicio abre el selector de '
                        'Bluetooth del navegador para emparejar con la '
                        'maqueta (SIPSVA-ESP32). Requiere Chrome, Edge u '
                        'Opera; Safari y Firefox no son compatibles con Web '
                        'Bluetooth.',
                      ),
                      if (controller.realConnectionError != null) ...<Widget>[
